...
public class MixedAdapter extends RecyclerView.Adapter<MixedAdapter.MixedViewHolder> {
    ...
    class MixedViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Mixed mixed) {
            ...
            if (mixed.isVip() && !BillingManager.getInstance(mainActivity).isPremiumActivated()) {
...
//
           ...
           // }
            ...
            String icon= mixed.getIcon();
            if(icon.contains("assets/"))
            {
                try {
                    Glide.with(itemView.getContext())
                            .load(Uri.parse("file:///android_asset/" + icon.replace("assets/", "")))
